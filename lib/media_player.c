...
libvlc_media_player_new( libvlc_instance_t *instance )
{
    ...
    var_Create (mp, "support-opengl-render-subtitles", VLC_VAR_BOOL | VLC_VAR_DOINHERIT);
    var_Create (mp, "support-black-area-subtitles", VLC_VAR_BOOL | VLC_VAR_DOINHERIT);
    ...
    var_Create (mp, "zspace-cookies", VLC_VAR_STRING | VLC_VAR_DOINHERIT);
    var_Create (mp, "use-llhls-live", VLC_VAR_INTEGER | VLC_VAR_DOINHERIT);
